        ...
        {activeView === 'main' ? (
                ...
                <div className="p-6 space-y-4 max-h-[70vh] overflow-y-auto custom-scrollbar bg-[#16181D]">
                  ...
                  <div className="space-y-2">
                      ...
                      <input 
                        ...
                        className="w-full bg-black/40 border border-white/10 rounded-xl px-4 py-3 text-sm text-white focus:border-blue-500 font-mono"
                      />
                  </div>
            ...
            <>
                ...
                <div className="p-6 bg-[#16181D] text-gray-300 text-sm space-y-4 max-h-[70vh] overflow-y-auto custom-scrollbar">
                    ...
                    <h3 className="text-white font-bold">2. Personal Keys</h3>
                    <p>When you provide a personal API Key, it is stored locally in your browser's localStorage. It is never transmitted to our servers beyond the necessary API calls to Google Gemini.</p>
                    ...
                    <p>We use SSL encryption and industry-standard security practices to protect your workspace.</p>
                </div>
            </>
        ) : (
             <>
